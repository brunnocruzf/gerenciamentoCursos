...
try {
    ...
    $stm = $conn->prepare('SELECT c.nome as nomecurso, c.*,u.*, uc.* FROM usuarios_cursos uc
            ...
            inner join cursos c on c.idcursos = uc.idcurso
             where c.quantidade_aulas = c.status and idusuarios = :iduser;');
            ...
            <div class="col-sm">
                <div class="card" style="width: 18rem;" style="margin-bottom: 5px">
                    <div class="card-body">
                        ...
                        <a type="submit" class="btn btn-primary" href="imprimeCertificado.php?nomecurso=<?= $certificado['nomecurso'] ?>&nome=<?= $certificado['nome'] ?>">Certificado</a>
